...
- timestamp: 2026-05-03T21:18:36Z
...
| search_semantic_p95_no_rerank_s | le 0.2 s | 0.1822 s | PASS |
| search_semantic_p95_with_rerank_s | le 7.0 s | 5.9206 s | PASS |
| search_structural_p95_s | le 0.1 s | 0.0010 s | PASS |
| search_symbol_p95_s | le 0.05 s | 0.0011 s | PASS |
| context_bundle_p95_s | le 1.5 s | 1.3904 s | PASS |
