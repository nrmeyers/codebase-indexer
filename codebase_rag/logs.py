...
EMBEDDING_STORE_RETRY = "Embedding upsert failed (attempt {attempt}/{max_attempts}), retrying in {delay:.1f}s: {error}"
...
EMBEDDING_RECONCILE_MISSING = "Embedding reconciliation: {missing} of {expected} embeddings missing (IDs: {sample_ids})"
