...
# _rewrite_descriptive_query``) keep working after the impl moved into
# ``app.services.retrieval``.
_rewrite_descriptive_query = retrieval_service._rewrite_descriptive_query
...
def semantic_search(
    ...
    _status_code = 200
    try:
        result = retrieval_service.semantic_search(q=q, k=k, repo=repo, rerank=rerank)
